...
<footer class="footer">
    <div class="footer-grid">
        ...
        <div class="footer-brand">
            ...
            <p class="footer-tagline">Curating exceptional furniture for discerning homes since 2018. Where timeless design meets modern luxury.</p>
        ...
        <div class="footer-col">
            ...
            <div class="footer-contact-item">
                ...
                <span>Kathmandu, Nepal<br>Open Mon - Sat, 10am - 7pm</span>
            </div>
            <div class="footer-contact-item">
