...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/productdetail.css?v=3">
</head>
<body>
...
<section class="apply-section" id="apply">
    <div class="apply-wrap">
        <div class="apply-intro">
            <span class="eyebrow">Can't add to cart right now?</span>
            <h2>Apply for <em>${product.productName}</em></h2>
            <p>Submit a request and our team will get back to you to confirm availability, pricing, and delivery details.</p>
        </div>
